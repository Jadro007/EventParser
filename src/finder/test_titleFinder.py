...
class TestTitleFinder(TestCase):
    ...
    def test_find_single_title_h2(self):
        html = "<html><body><div>" \
    ...
    def test_find_single_title_h3(self):
        html = "<html><body><div>" \
    ...
    def test_find_single_title_h4(self):
        html = "<html><body><div>" \
    ...
    def test_find_single_title_in_title(self):
    ...
    def test_find_title_in_parents(self):
    ...
    def test_find_with_selected_event_outside_of_other_events_takes_h1(self):
    ...
    def test_find_with_selected_event_outside_of_other_events_takes_title_in_head(self):
        # this is here to test that it will not take titles from other events
        html = "<html>" \
